...
func AppPodHealthCheck(name string, namespace string) string {
	...
	query := fmt.Sprintf("kube_pod_container_status_ready{namespace='%s', container='%s'}", namespace, name)
